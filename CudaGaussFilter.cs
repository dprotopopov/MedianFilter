...
namespace img
{
    internal class CudaGaussFilter : IFilter
    {
        ...
        public CudaGaussFilter(Bitmap btm, int gridSize, int blockSize, double sigma)
        {
            _sigma = sigma;
            if (Newbmp != null)
                Newbmp.Dispose();
        ...
        public bool Filter()
        {
            try
            {
                ...
                string command = string.Format("/C cudagaussfilter {0} {1} {2} {3} {4} {5} {6} {7} >> cuda.log",
                    "gauss",
                    _sigma,
                    _width, _height,
